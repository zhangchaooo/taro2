...
export default class Loading extends Component {
  render() {
    ...
    const cnt = loading || _oneLoading
      ? <AtActivityIndicator  size={100} color='#6697E9' mode='center'></AtActivityIndicator>
      : noData
        ? noDataText ? noDataText : '暂无内容'
        : noMore
            ? '—— 没有更多 ——'
            : mLoading
